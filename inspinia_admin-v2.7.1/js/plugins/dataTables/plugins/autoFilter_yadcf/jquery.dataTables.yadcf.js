...
(function (root, factory) {
	...
	var yadcf = (function () {
		...
		var tablesDT = {},
			...
			placeholderLang = {
				'select': '(Seleccionar)',        //'select': 'Select value',  
				'select_multi': '(Seleccionar)', //'select_multi': 'Select values',
				'filter': '(Filtro...)',         //'filter': 'Type to filter',
				'range': ['Desde', 'Hasta'],     //'range': ['From', 'To'],
				'date': '(Fecha)'                //'date': 'Select a date'
			},
			settingsMap = {};
		...
		function addRangeNumberFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, ignore_char) {
			...
			$(filter_selector_string).append("<br/>"); //dycec. Filtro debajo del columnCaption
					...
					if ($filter_selector.length === 1) {
						...
						if (filter_container_id === undefined && columnObj.filter_container_selector === undefined) {
							...
							if ($("#yadcf-filter-wrapper-" + columnObj.filter_container_selector).length === 0) {
								/* Comentado, esto es para un contenedor de filtros fuera del columnHeader
								//$(filter_selector_string).append("<br/>"); //dycec. Filtro debajo del columnCaption
								*/
